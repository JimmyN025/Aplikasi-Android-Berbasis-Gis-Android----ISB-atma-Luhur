package ac.id.atmaluhur.mahasiswa.aplikasilokasi;
...
import ac.id.atmaluhur.mahasiswa.aplikasilokasi.api.ApiClient;
import ac.id.atmaluhur.mahasiswa.aplikasilokasi.api.ApiService;
import ac.id.atmaluhur.mahasiswa.aplikasilokasi.model.ListLocationModel;
import ac.id.atmaluhur.mahasiswa.aplikasilokasi.model.LocationModel;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void initMarker(List<LocationModel> listData){
        for (int i=0; i<mListMarker.size(); i++){
            ...
            LatLng latLng = new LatLng(Double.parseDouble(mListMarker.get(0).getLatitude()), Double.parseDouble(mListMarker.get(i).getLongitude()));
